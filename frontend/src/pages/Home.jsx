          ...
          <div className="mt-4">
            {update ? (
              <button
                ...
                className="text-white bg-red-700 hover:bg-purple-800 focus:outline-none focus:ring-4 focus:ring-purple-300 font-medium rounded-full text-md px-5 py-2.5 text-center mb-2"
              >
                Update Data
              </button>
            ) : (
